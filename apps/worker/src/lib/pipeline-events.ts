...
export async function getEntityEvents(
  ...
  return result.results as unknown as PipelineEvent[]
}
...
export async function getLatestEvent(
  ...
  return (result as unknown as PipelineEvent) ?? null
}
...
export async function getStepDurationMetrics(
  ...
  return result.results as unknown as StepDurationMetric[]
}
...
export async function getEventCountByType(
  ...
  return result.results as unknown as PipelineEventCountByType[]
}
